...
import numpy as np
from dragondiff.src.unet.unet_2d_condition import DragonUNet2DConditionModel
from dragondiff.src.unet.estimator import MyUNet2DConditionModel
...
from dragondiff.src.utils.inversion import DDIMInversion
from dragondiff.src.unet.attention_processor import IPAttnProcessor, AttnProcessor, Resampler
from transformers import CLIPVisionModelWithProjection, CLIPImageProcessor
from dragondiff.src.models.Sampler import Sampler

class DragonPipeline:
    def __init__(self, sd_id='./StableDiffusion/', ip_id='dragondiff/models/ip_sd15_64.bin', NUM_DDIM_STEPS=50, precision=torch.float32, ip_scale=0):
        ...
        onestep_pipe.estimator = MyUNet2DConditionModel.from_pretrained(sd_id, subfolder="unet",vae=None, text_encoder=None, tokenizer=None,
                                ...
                                safety_checker=None, feature_extractor=None,).to('cuda:0', dtype=precision)
    ...
    def get_image_embeds(self, pil_image):
        ...
        clip_image = clip_image.to('cuda:0', dtype=self.precision)
    ...
    def load_adapter(self, model_path, scale=1.0):
        ...
        for name in self.pipe.unet.attn_processors.keys():
            ...
            if cross_attention_dim is None:
                ...
                scale=scale,num_tokens= self.num_tokens).to('cuda:0', dtype=self.precision)
